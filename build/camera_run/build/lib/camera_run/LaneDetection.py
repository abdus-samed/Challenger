...
#####################################################################
    ...
    def readVideo(self):
        ...
        inpImage = cv2.VideoCapture("/home/samet/hallo/src/camera_run/camera_run/drive.mp4")
    ...
    def __init__(self):
        ...
        self.cap = cv2.VideoCapture('/home/samet/advanced_lane_detection/drive.mp4')
        self.br = CvBridge()
        
       
            
        
        #self.bridge = CvBridge() #1
    ...
    def timer_callback(self):
            ...
            image = self.readVideo()        #   reads video in the workspace
            print('IMAGE',image)
            ...
            while True:
                ...
                while rclpy.ok():
                    if curveDir == 'Left Curve':
                        speed = -0.4
                        steering_angle= -0.85
                    elif curveDir == 'Right Curve':
                        speed = -0.4
                        steering_angle = 0.0
                    else:
                        speed = -0.8
